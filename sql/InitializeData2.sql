...
VALUES 
	(NULL, '1', '5', '1', '2018-10-16', '2020-10-15', 'one tablet twice a day', '100', 'Reduces the effects of natural chemical histamine in the body', '2', 'Keep out of reach from children', 'walgreens', '0'),
	...
	(NULL, '4', '7', '4', '2018-10-16', '2019-10-15', '1 pill per day', '100', 'Treatment of major depressive disorder (MDD)', '1', 'Do not take with empty stomach', 'cvs', '0'),
	(NULL, '5', '8', '1', '2018-10-19', '2019-10-18', '2 drops in each nossel', '1', 'Relieve seasonal and year-round allergic and non-allergic nasal symptoms, such as stuffy/runny nose', '1', 'Keep at cool place ', 'costco', '0'),
	(NULL, '8', '9', '3', '2018-10-16', '2019-10-15', '1 pill per day', '50', 'Used to relieve moderate to severe pain.', '2', 'Do not take with empty stomach', 'Walgreens', '0'),
	(NULL, '6', '10', '4', '2018-10-16', '2018-10-15', 'one pill per day', '100', 'Extra water by increasing the amount of urine you make', '1', 'Keep it in a cool place', 'CVS', '0'),
	(NULL, '7', '11', '3', '2018-10-17', '2019-10-16', 'take 1 pill, twice a day', '100', 'Can treat many diseases and conditions, especially those related to inflammation.', '2', 'do not take with empty stomach', 'Walgreens', '0')
